    ...
    render() {
        return (
            <Container style = {{flex: 1, backgroundColor: 'white'}}>
                <Header>
                        <Left><Icon name = "person-add" style = {{paddingLeft: 10}}></Icon></Left>
                        <Body><Text>My Profile</Text></Body>
                        <Right><Icon name = "ios-menu" style = {{paddingRight: 10}}></Icon></Right>
                </Header>
                <Content>
                    <View style = {{paddingTop: 10}}>
                        <View style = {{ flexDirection: 'row'}}>
                            <View style = {{flex: 1, alignItems: 'center'}}>
                                <Image source = {require ('../../assets/resize.jpg')}
